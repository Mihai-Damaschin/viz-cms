...
export interface ApiAccessoryAccessory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['net', 'sill', 'glass']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    header_brands: Schema.Attribute.Relation<
      'oneToMany',
      'api::header-brand.header-brand'
    >;
    key_features: Schema.Attribute.Component<'key-features.features', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeaderBrandHeaderBrand extends Struct.CollectionTypeSchema {
  collectionName: 'header_brands';
  info: {
    displayName: 'Header brand';
    pluralName: 'header-brands';
    singularName: 'header-brand';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    features: Schema.Attribute.Component<'key-features.key-features', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    type: Schema.Attribute.Enumeration<['window', 'door', 'balcon']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
